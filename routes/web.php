...
Route::middleware(['auth', 'role:collector'])
    ...
    ->group(function () {
        ...
        Route::prefix('payments')->name('payments.')->group(function () {
            ...
            Route::post('/', [CollectorController::class, 'storePayment'])->name('store');
            Route::get('{id}', [CollectorController::class, 'showPayment'])->name('show');
            Route::put('{id}', [CollectorController::class, 'updatePayment'])->name('update');
        });
