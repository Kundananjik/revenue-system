            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($payments as $payment)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        {{-- FIXED: Added the missing cell for Payment Method --}}
                        <td class="px-4 py-3 text-sm text-gray-600">
                            <span class="bg-gray-100 px-2 py-1 rounded text-xs uppercase">{{ $payment->payment_method ?? 'N/A' }}</span>
                        </td>
                ...
                @empty
                    <tr>
                        {{-- FIXED: Increased colspan to 10 to cover the new column --}}
