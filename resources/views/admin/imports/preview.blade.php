    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            @if($import->invalid_rows > 0)
                <div class="bg-red-50 border border-red-200 text-red-800 rounded-2xl p-4 mb-6">
                    <p class="font-semibold">Some rows are invalid</p>
                    <p class="text-sm mt-1">Fix your CSV and upload again, or adjust mapping</p>
                </div>
            @else
                <div class="bg-green-50 border border-green-200 text-green-800 rounded-2xl p-4 mb-6">
