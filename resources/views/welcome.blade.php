        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col items-center justify-center space-y-6">
                ...
                <div class="flex flex-wrap justify-center gap-6 items-center">
                    <a href="mailto:kundananjisimukonda@gmail.com" class="group flex items-center gap-2 hover:text-blue-400 transition-all duration-200 text-sm font-medium">
                    ...
                    <a href="tel:+260971863462" class="group flex items-center gap-2 hover:text-blue-400 transition-all duration-200 text-sm font-medium">
                        <div class="p-2 bg-gray-800 rounded-lg group-hover:bg-blue-600/10 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.linkedin.com/in/kundananji-simukonda" target="_blank" class="group flex items-center gap-2 hover:text-blue-400 transition-all duration-200 text-sm font-medium">
                        <div class="p-2 bg-gray-800 rounded-lg group-hover:bg-blue-600/10 transition-colors">
                    ...
                    <a href="https://github.com/Kundananjik" target="_blank" class="group flex items-center gap-2 hover:text-blue-400 transition-all duration-200 text-sm font-medium">
                        <div class="p-2 bg-gray-800 rounded-lg group-hover:bg-blue-600/10 transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
