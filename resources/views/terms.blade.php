...
<head>
    ...
    <title>Terms of Use | Revenue System</title>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100/60">
            ...
            <div class="prose max-w-none">
                <p class="text-gray-700 leading-relaxed">
                    These Terms govern your use of <span class="font-semibold">Revenue System</span>. By accessing or using the platform, you agree to comply with these Terms.
                    If you do not agree, do not use the platform.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">1. Platform Purpose</h2>
                <p class="text-gray-700 leading-relaxed">
                    Revenue System is designed to track revenue related activities, manage user roles, record payments, and generate reports for accountability and operational management.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">2. Accounts and Roles</h2>
                <ul class="list-disc pl-6 text-gray-700 space-y-2">
                    <li>You must use only your authorized account.</li>
                    <li>Your access depends on your assigned role (user, collector, admin, super admin).</li>
                    <li>You are responsible for activities performed under your credentials.</li>
                </ul>

                <h2 class="text-xl font-bold text-gray-900 mt-8">3. Acceptable Use</h2>
                <ul class="list-disc pl-6 text-gray-700 space-y-2">
                    <li>Do not attempt unauthorized access, privilege escalation, or bypass security controls.</li>
                    <li>Do not insert false or misleading payment records.</li>
                    <li>Do not upload malicious content or attempt to disrupt the service.</li>
                    <li>Use the system only for lawful and authorized revenue management activities.</li>
                </ul>

                <h2 class="text-xl font-bold text-gray-900 mt-8">4. Data Accuracy and Responsibility</h2>
                <p class="text-gray-700 leading-relaxed">
                    Users must ensure information entered is accurate. Reports and exports reflect the data recorded in the system.
                    Administrators are responsible for reviewing entries, resolving disputes, and ensuring correct operational procedures.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">5. Audit and Logging</h2>
                <p class="text-gray-700 leading-relaxed">
                    The platform may keep audit logs of actions performed within the system, especially for privileged roles.
                    These logs support accountability, security investigations, and reporting.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">6. Availability and Changes</h2>
                <p class="text-gray-700 leading-relaxed">
                    The platform is provided as is. Features may be updated, improved, or changed over time.
                    We may suspend access for maintenance, security, or policy enforcement.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">7. Limitation of Liability</h2>
                <p class="text-gray-700 leading-relaxed">
                    To the maximum extent permitted by law, Revenue System and its developer are not liable for indirect losses, data loss, or business interruption arising from system use, misuse, or downtime.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">8. Termination</h2>
                <p class="text-gray-700 leading-relaxed">
                    Access may be suspended or terminated if you violate these Terms or if your role authorization is removed.
                </p>

                <h2 class="text-xl font-bold text-gray-900 mt-8">9. Contact</h2>
                <p class="text-gray-700 leading-relaxed">
            ...
            <div class="mt-10 pt-6 border-t border-gray-100 flex items-center justify-between">
                ...
                <a href="{{ url('/privacy') }}" class="text-gray-700 hover:text-blue-600 font-semibold">Privacy Policy</a>
            </div>
        </div>
    </main>
